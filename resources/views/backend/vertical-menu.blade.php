@php
    ...
    $profile_image = !empty($data->profile_image) ? url('upload/admin_images/'.$data->profile_image) : url('upload/no_image.jpg');
@endphp
...
<div class="vertical-menu">
    ...
    <div data-simplebar class="h-100">
        ...
        <div class="user-profile text-center mt-3">
            <div class="">
                <img src="{{ $profile_image }}" alt="" class="avatar-md rounded-circle">
            </div>
            <div class="mt-3">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('frontend.home.slide.edit.form') }}">Home Slide</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('frontend.about.edit.form') }}">About Page</a></li>
                    </ul>
                </li>


                <li>
                    <a href="{{route('backend.change.password')}}" class="waves-effect">
                        <i class="ri-dashboard-line"></i><span class="badge rounded-pill bg-success float-end"></span>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('backend.supplier.view') }}">All Suppliers</a></li>
                    </ul>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('backend.supplier.create.form') }}">Add Supplier</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('backend.customer.index') }}">All Customers</a></li>
                    </ul>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('backend.customer.create.form') }}">Add Customer</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('backend.category.index') }}">All Categories</a></li>
                    </ul>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('backend.category.create') }}">Add Category</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('backend.product.index') }}">All Products</a></li>
                    </ul>
                    <ul class="sub-menu" aria-expanded="false">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('backend.unit.index') }}">All Units</a></li>
                    </ul>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('backend.unit.create') }}">Add Unit</a></li>
                    </ul>
                </li>
