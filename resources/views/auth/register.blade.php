...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Register | Inventor MS - Admin & Dashboard Template</title>
                ...
                <div class="p-3">
                    <form method="post" class="form-horizontal mt-3" action="{{route('register')}}">
                        ...
                        <div class="form-group mb-3 row">
                            <div class="col-12">
                                <input class="form-control" type="text" required placeholder="Name" id="name" name="name">
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3 row">
                            <div class="col-12">
                                <input class="form-control" type="password" placeholder="Password Confirmation" id="password_confirmation"
