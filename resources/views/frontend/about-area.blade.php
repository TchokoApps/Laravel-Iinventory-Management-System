        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="about__content">
                    ...
                    <p class="desc">I love to work in User Experience & User Interface designing. Because I love to solve the design problem and
                        find easy and better solutions to solve it. I always try my best to make good user interface with the best user
