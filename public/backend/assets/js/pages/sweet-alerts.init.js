!function (t) {
    ...
    e.prototype.init = function () {
        t("#sa-basic").on("click", function () {
            Swal.fire({title: "Any fool can use a computer", confirmButtonColor: "#0f9cf3"})
        }), t("#sa-title").click(function () {
            Swal.fire({title: "The Internet?", text: "That thing is still around?", icon: "question", confirmButtonColor: "#0f9cf3"})
            ...
            Swal.fire({
                ...
                Swal.fire({icon: "success", title: "Ajax request finished!", confirmButtonColor: "#0f9cf3", html: "Submitted email: " + t})
            })
            ...
            Swal.mixin({
                ...
                progressSteps: ["1", "2", "3"]
            }).queue([{title: "Question 1", text: "Chaining swal2 modals is easy"}, "Question 2", "Question 3"]).then(function (t) {
                t.value && Swal.fire({
                    title: "All done!",
